...
export default function FormulaireDevisCommunication() {
        ...
        <RetourRafraichir path=""/>
        {
            formulaireDevisOk ? (
                ...
                <div className="devis_inside">
                    ...
                    <p>Formulaire de devis<br/>Communication</p>
                            ...
                            <input type="text" placeholder="Type de devis" onChange={() => null} value={typeDevisValue} onClick={handleClickTypeDevis} required/>
                            {
                                ...
                                ( 
                                    ...
                                    <div className="liste_deroulant_severite">
                                        <p onClick={() => handleClickChoixDevis("Systèmes de conference")}>Systèmes de conference</p><br/><p onClick={() => handleClickChoixDevis("Web RTC")}>Web RTC</p><br/><p onClick={() => handleClickChoixDevis("Affichage dynamique")}>Affichage dynamique</p>
                                    </div>
                                    </>
                                ) 
                            }
