...
export default function FormulaireDevisInfogerance() {
        ...
        <RetourRafraichir path=""/>
        {
            formulaireDevisOk ? (
                ...
                <div className="devis_inside">
                    ...
                    <p>Formulaire de devis<br/>Infogerance</p>
                            ...
                            <input type="text" placeholder="Type de devis" onChange={() => null} value={typeDevisValue} onClick={handleClickTypeDevis} required/>
                            {
                                ...
                                ( 
                                    ...
                                    <div className="liste_deroulant_severite">
                                        <p onClick={() => handleClickChoixDevis("Serveur et hebergement")}>Serveur et hebergement</p><br/><p onClick={() => handleClickChoixDevis("Saas et laas")}>Saas et laas</p><br/><p onClick={() => handleClickChoixDevis("Câblage réseaux")}>Câblage réseaux</p><br/><p onClick={() => handleClickChoixDevis("Protection des données")}>Protection des données</p>
                                    </div>
                                    </>
                                ) 
                            }
