...
export default function FormulaireDevisSecurite() {
        ...
        <RetourRafraichir path=""/>
        {
            formulaireDevisOk ? (
                ...
                <div className="devis_inside">
                    ...
                    <p>Formulaire de devis<br/>Securite</p>
                    <form type="submit" onSubmit={devis}>
                    <div  className="devis_inside_input">
                        <label>Nom</label>
                        <input type="text" placeholder="Ex : Doe" ref={nom} />
                        <label>Prénom</label>
                        <input type="text" placeholder="Ex : John" ref={prenom}/>
                        <label>Téléphone</label>
                        <input type="text" placeholder="Ex: 062792...." ref={telephone}/>
                        <label>Entreprise</label>
                        <input type="text" placeholder="Ex: Integraphone" ref={entreprise}/>
                        <label>Type de devis</label>
                        <div className="devis_password_eyes">
                            <input type="text" placeholder="Type de devis" onChange={() => null} value={typeDevisValue} onClick={handleClickTypeDevis}/>
                            {
                                typeDevis ? (
                                ...
                                ( 
                                    ...
                                    <div className="liste_deroulant_severite">
                                        <p onClick={() => handleClickChoixDevis("Vidéo-surveillance")}>Vidéo-surveillance</p><br/><p onClick={() => handleClickChoixDevis("Alarme")}>Alarme</p><br/><p onClick={() => handleClickChoixDevis("Contrôle d'accès")}>Contrôle d'accès</p>
                                    </div>
                                    </>
                                ) 
                            }
                        ...
                        <label>Mail</label>
                        <input type="text" placeholder="Ex: john.doe@gmail.com" ref={email}/>
                        <label>Adresse</label>
                        <input type="text" placeholder="Ex: 31 avenue jean moulin" ref={adresse}/>
                        <div className="input_ville_departement">
                            <input onChange={handleVilleChange} value={villeValue} type="text" placeholder="Ville"/>
                            {ville && <div className="liste_deroulant_type_ville">
                        {
                            ...
                            <input onChange={handleDepartementChange} value={departementValue} type="text" placeholder="Département"/>
